...
date: 2021-04-03
hero: /images/post-covers/deploying-a-full-stack-web-application.png
excerpt: Releasing the beta version of jadeocr-next
authors:
  - Tanay Biradar
---

## Releasing the beta version of jadeocr-next
...
[^fn1]. Although I faced several (frustrating) hurdles while writing the
...
[^fn1]: For now, we are running jadeocr-next on a virtual private server (VPS),
